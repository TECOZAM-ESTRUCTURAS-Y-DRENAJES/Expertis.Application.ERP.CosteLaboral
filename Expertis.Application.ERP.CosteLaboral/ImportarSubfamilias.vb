...
Public Class ImportarSubFamilias
    ...
    Public Function ObtenerDatosExcel(ByVal ruta As String, ByVal hoja As String, ByVal rango As String) As DataTable
        ...
        MyCommand = New System.Data.OleDb.OleDbDataAdapter("select * from [" & rango & "]", MyConnection)
